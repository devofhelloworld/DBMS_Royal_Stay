...
exports.gethousekeeping = (req,res,next)=>{
  res.render('housekeeping',{isloggedin:req.session.isloggedin,isadminloggedin:req.session.isadminloggedin,hoteldata:hoteldata,useremail: req.session.useremail});
}
...
exports.getstaff = (req,res,next)=>{
  ...
  res.render('staff',{isloggedin:req.session.isloggedin,isadminloggedin:req.session.isadminloggedin,value:id,hoteldata:hoteldata,useremail: req.session.useremail});
}
